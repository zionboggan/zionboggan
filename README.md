...
I build security tooling, trading systems, and the infrastructure to run them.
...
- **Quantitative development.** Automated trading systems: data, signals, execution, and the plumbing that keeps them honest.
